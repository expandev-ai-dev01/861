...
/**
 * @page WelcomePage
 * @summary Welcome page introducing the TODO List application
 * @domain core
 * @type landing-page
 * @category public
 *
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Welcome to TODO List</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-16">
        ...
        <Card>
          <div className="p-6">
            ...
            <p className="text-gray-600">
              View all your tasks in an organized list with filtering and sorting capabilities.
            </p>
          </div>
        </Card>
      </div>
